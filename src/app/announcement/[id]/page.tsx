...
import carExample from "../../../Components/Card/assets/carExample.png";
        ...
        <div className="flex w-full flex-wrap justify-between gap-3.5">
          <div className="flex w-full max-w-full flex-col gap-8 [@media(min-width:1262px)]:max-w-3xl">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-9 rounded bg-grey10 px-5 pb-7 pb-8 pt-11">
            ...
            <div className="flex flex-col gap-8 rounded bg-grey10 px-5 pb-7 pb-8 pt-11">
          ...
          <div className="flex w-full max-w-full flex-col gap-8 [@media(min-width:1262px)]:max-w-md">
            <div className="flex flex-col gap-8 rounded bg-grey10 px-5 pb-7 pb-8 pt-9">
              ...
              <div className="grid max-h-52 grid-cols-3 gap-x-3.5 gap-y-8 overflow-y-scroll">
                <Image
                  className="h-full bg-grey7 object-contain"
                  src={carExample}
                  alt="Imagem do veículo"
                />
                <Image
